  ...
  return (
    <View style={{
      ...
      >
        ...
        {queryData.length > 0 ?
        <PesananCard screen='brand' buttonPressHandler={()=>{navigation.push('Detail')}} name={queryData[0].data.name} price={0} location= {queryData[0].data.city} type= {queryData[0].data.category} imagelink= {queryData[0].data.imageURL}></PesananCard>
