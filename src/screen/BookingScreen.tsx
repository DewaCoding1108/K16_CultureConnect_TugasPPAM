...
const BookingScreen = ({ navigation,route }: any) => {
  ...
  let totalharga = lamaTampil * price;
          ...
          <View style={styles.FormContainer}>
            ...
            <View style={styles.DetailContainer}>
              <View style={{flexDirection:'row',justifyContent:'space-between',marginHorizontal:SPACING.space_28, marginTop:SPACING.space_18}}>
                <View>
                  <Text style={[styles.TextParagraph]}>Tarif Seniman </Text>
                  <Text style={[styles.TextParagraph]}>Lama Tampil </Text>
        ...
        <View
            ...
            >
              ...
              <AppButton
                ...
                onPress={()=>{navigation.push("PaymentDetails",{TotalPrice:totalharga, Chart:[{"data":{"name":name,"price": totalharga,"detail": detail,"category": tipe,"senimanID": senimanID,"imageURL": imageURL},'id':id }]})}}
              />
