...
const DetailScreen2 = ({navigation,route}:any) => {
  ...
  const providerCategory = (tipe:any) => {
    if(tipe == "Seni"){
      return "Sanggar";
    }
    else if(tipe == "Jasa Seni"){
      return "Seniman";
    }
    else if(tipe == "Sewa Pakaian"){
      return "Toko Sewa";
    }
    else if(tipe == "Karya Seni"){
      return "Toko Seni"
    }
    else{
      return '';
  ...
  const providerTipe = providerCategory(tipe.toString());
    ...
    <View style={styles.ScreenContainer}>
      ...
      <View style={{paddingHorizontal:SPACING.space_15, paddingVertical:SPACING.space_10}}>
        ...
        <View style={styles.line}/>
        {
          ...
          :
          <>
          <TouchableOpacity activeOpacity={0.7} onPress={()=>{navigation.push('Detail',
          {id:sanggarID, 
