    ...
    <View style={styles.ScreenContainer}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.ScrollViewFlex}>
        <View style={styles.CardContainer}>
          <SeniCard buttonPressHandler={()=>{navigation.push('Category',{category:'Sanggar'})}} name="Sanggar Seni" description= "Temukan bakat seni Anda dalam lukisan, tari, musik, dan teater di satu tempat yang penuh kreativitas" imagelink={require("../../src/assets/app_images/Home_SanggarSeni.png")}/>
          <SeniCard buttonPressHandler={()=>{navigation.push('Category',{category:'Jasa Seni'})}} name="Jasa Penampilan Seni" description= "Temukan seniman berbakat untuk acara Anda! Dari musisi hingga seniman tari, jelajahi ragam talenta" imagelink={require("../../src/assets/app_images/Home_JasaTampil.png")}/>
          <SeniCard buttonPressHandler={()=>{navigation.push('Category',{category:'Sewa Pakaian'})}} name="Sewa Pakaian/Musik Tradisional" description= "Temukan pakaian atau alat musik terbaik untuk acara Anda! Dari pakaian adat, tari, hingga alat musik tradisional" imagelink={require("../../src/assets/app_images/Home_SewaPakaian.png")}/>
