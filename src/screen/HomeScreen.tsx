    ...
    <View style={styles.ScreenContainer}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.ScrollViewFlex}>
        <View style={styles.CardContainer}>
          ...
          <SeniCard buttonPressHandler={()=>{navigation.push('Category',{category:'Sewa Pakaian'})}} name="Sewa Pakaian Tradisional" description= "Temukan pakaian tradisional terbaik untuk acara Anda! Dari pakaian adat hingga pakaian tari" imagelink={require("../../src/assets/app_images/Home_SewaPakaian.png")}/>
