...
const HomeScreen = ({navigation}:any) => {
  ...
  return (
    <View style={styles.ScreenContainer}>
      ...
      <ImageBackground resizeMode="repeat" source={require("../../src/assets/app_images/HomePageImage.png")} imageStyle={{objectFit:"cover", height:350}} style={{width:"100%", height: 200}}>
        <View style={{paddingHorizontal:20, marginTop:94}}>
          <Text style={styles.TextHeader}>
            Tempat Inspirasi Tanpa Batas
          </Text>
